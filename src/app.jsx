    ...
    return (
        <Card className="flex flex-col h-full relative group">
            ...
            <div className="p-4 bg-slate-50 border-b border-slate-100 flex flex-col gap-3">
                ...
                <button
                    onClick={() => onOpenConfig(type)}
                    className="w-full py-2 bg-white border border-slate-300 hover:border-blue-400 hover:text-blue-600 text-slate-600 rounded text-sm font-medium flex items-center justify-center gap-2 transition-all"
                >
                    <Edit3 size={14} /> 修改配置 / 区间
                </button>
            ...
            <div className="flex-1 p-4 flex flex-col justify-center min-h-[120px]">
              ...
              ${isDragging ? 'border-blue-500 bg-blue-50' : 'border-slate-300 hover:border-blue-400 hover:bg-slate-50'}`}
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4 text-center w-full">
                        ...
                        <div className="text-xs text-green-600">池内库存: {data.rows.length} 条</div>
                    </div>
                )}
            </div>
        </Card>
        ...
        <div className="min-h-screen bg-slate-100 p-4 md:p-8 font-sans text-slate-800">
            ...
            <div className="max-w-7xl mx-auto space-y-6">
                <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div className="flex gap-2">
                        <button onClick={openJsonConfig} className="bg-slate-800 text-white hover:bg-slate-900 px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2 transition-colors">
                            <FileJson size={16} /> 全局规则配置
                        </button>
